...
- (void)setListType:(ListOfUsers)listType {
    ...
    switch (self.listType) {
        ...
        case ListOfUsersPROD:        case ListOfUsersQA:
        case ListOfUsersDEV: {
...
//            [QBSettings setAuthSecret:@"BTFsj7Rtt27DAmT"];
            ...
            [QBSettings setApplicationID:42648];
            [QBSettings setAuthKey:@"7-RXuAjPERnr9tF"];
            [QBSettings setAuthSecret:@"KQ8Vx-D4rCnE8OA"];
            [QBSettings setAccountKey:@"8yvE5qsxxHoZt4Xs4ctF"];
